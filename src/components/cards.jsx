...
export default function Cards() {
 ...
 // const data = {};
  ...
  return (
    <>
      {Object.keys(data).length === 0 ? (<div style={{ width: "200px", height: "200px", position:"absolute", margin: "330px" }}><CircularProgressbar value={percentage} text={`${percentage}%`} /></div>) :
        (<><div>
          <article>
            ...
            <div className="content-container">
              ...
              <p className="content">{data[0]?.flight_number
              }</p>
            </div>
            <div className="content-container">
              <h4 className="content-type">Time(utc)</h4>
              <p className="content">{formatDate(data[0]?.launch_date_utc)}</p>
            </div>
            <div className="content-container">
            ...
            <div className="content-container">
              ...
              <p className="content"><RocketLogo/></p>
            </div>
            <div className="content-container">
        ...
        <div>
          <article>
            ...
            {data2?.map((base,index)=>{
              ...
              <h4 className="content-type">region</h4>
              ...
              <h4 className="content-type">{index+30+"°C"}</h4>
            </div>
            <div className="content-container">
            ...
            <div className="content-container">
              ...
              <h4 className="content-type">{index+5+"m/s"}</h4>
            </div>
                  </div>
                </div>
              </div>)
        ...
        <article>
            ...
            <div className="content-container">
              <h4 className="content-type">Flight number</h4>
              <p className="content">{data3.flight_number
              }</p>
            </div>
            <div className="content-container">
              <h4 className="content-type">Time(utc)</h4>
            ...
            <div className="content-container">
              ...
              <p className="content"><MissionPatch/></p>
            </div>
            <div className="content-container">
              <h4 className="content-type">crew</h4>
              <div className="content">{data3?.crew?.map((i)=>{
                return <div key={i}><CrewImg/></div>
              })}</div>
            </div>
        ...
        <div>
          <article style={{width: 380}}>
            <h3>Starlink</h3>
              <Starlink/>
              <div>  There are currently {data4?.totalDocs} active Starlink satellites on the low Earth orbit. </div>
          </article>
        </div>
       </> )
        }
